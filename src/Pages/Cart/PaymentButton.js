...
const PaymentButton = () => {
    //secrete key : nsVSGMocCPtwmVoU3ndiRgKe
    //key id : rzp_test_SmZeJidun1X0rz
    //merchant id : OJku8v0fLWXh6N
    ...
    const displayRazorpay = () => {
        const options = {
            "key": "rzp_test_SmZeJidun1X0rz", // Enter the Key ID generated from the Dashboard
